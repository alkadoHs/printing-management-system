...
if (isset($_POST['submit'])) {
    ...
    if (empty($username) && empty($pass)) {
       $emptyErr = "Haujajaza sehemu za muhimu";
        ...
        $sql = $conn->query("INSERT INTO users(username, password, cheo)
        VALUES('$username', '$pass', '$cheo')");
    ...
    <main>
        ...
        <div class="sidebar">
            ...
            <div class="dashboard-contents">
                ...
                <div class="contents">
                    <h1>Watumiaji Wa Essam Digital Management System</h1>
                    <h3>sajili mfanyakazi mpya</h3>
                   <div class="table">
                      ...
                      <div class="form-grid">
                         <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF'])?>" method="post">
                            ...
                            <div class="customer-number">
                                ...
                                <input type="text" name="pass" id="pass" placeholder="Jaza password atakayoikumbuka">
                            </div>
                            <div class="customer-work">
                                <label for="kazi">Msajili kama</label>
                                <select name="cheo" id="kazi">
                                    <option value="staff">Staff</option>
                                    <option value="Adminstrator">Adminstrator</option>
                                </select>
                            </div>
                            <div class="submitBtn">
                                <button class="btn-grad" title="hifadhi oda" type="submit" name="submit">Sajili Mfanyakazi</button>
                            </div>
                         </form>
                      </div>
                   </div>
                   ...
                   <?php if ($sql->num_rows > 0) {?>
                    <table id="myTable">
                        ...
                        <tr>
                            ...
                            <td><a href="deletemfanyakazi.php?id=<?=$row['id']?>">delete</a></td>
                        </tr>
                        <?php }?>
